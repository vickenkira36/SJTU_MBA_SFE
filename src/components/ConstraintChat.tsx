...
function createPresetConstraints(): PresetConstraint[] {
  return [
    ...
    {
      id: 'preset-split-count',
      description: '每家医院至少分配1个辖区；index≥1500时，最多分配floor(index/1000)+1个辖区',
      type: 'split_count',
      value: 1,
      value2: 1500,
      priority: 'soft',
    ...
    {
      id: 'preset-split-ratio',
      description: '拆分比例加和必须为100%',
      type: 'split_ratio_sum',
      value: 100,
      priority: 'hard',
      valid: true,
      isPreset: true,
    ...
    {
      id: 'preset-geo-distance',
      description: '同一辖区内医院间最大距离不超过200公里',
