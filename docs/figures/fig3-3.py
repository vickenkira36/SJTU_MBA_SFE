...
from _style import apply_style, C_PRIMARY, C_LINE
...
# 主轴：销售额柱状图（深灰）
bars = ax1.bar(years, sales, color=C_PRIMARY, width=0.55,
...
# 副轴：一线人员折线图（黑色实线）
ax2 = ax1.twinx()
line, = ax2.plot(years, people, color=C_LINE, marker='o', linewidth=1.8,
